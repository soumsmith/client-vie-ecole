...
/**
 * Hook pour récupérer des données d'API avec capacité de refetch (méthode GET)
 * @param {string} url - URL de l'API
 * @param {Object} params - Paramètres pour la requête (query parameters)
 ...
 */
const useFetchDataByGet = (apiEndPoint, params, dataKey, refreshTrigger = 0, customHeaders = {}) => {
  ...
  const validateParams = (params) => {
    if (!params) return { isValid: true, cleanParams: {} };
...
export default useFetchDataByGet;