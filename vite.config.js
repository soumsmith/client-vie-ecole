...
export default defineConfig({
  ...
  server: {
    proxy: {
      '/api': {
        target: 'http://46.105.52.105:8889', //http://10.3.119.232:8889 // https://api-pro.pouls-scolaire.net
        secure: false, // Désactiver la vérification stricte du certificat SSL
